...
| **Phase 4 ✅** | §3.3 API 收口(71 调用点/31 文件，SSE 保留+300s 超时) + §3.4 死代码(-1032 行) + §3.5 TS/ESLint 工具链 | 2026-09-04 | 前端工程化 |
| **Phase 5 ✅** | §2.4 LLM Gateway(app/llm 核心落地+存量迁移路线) + §2.6 配置治理✅(83字段) + §2.8 reindex CLI✅ + §3.6 storage层✅ | 2026-09-04 | 长期健康度 |
| **Phase 6（收官，基建✅）** | 全站中英文：shim/切换按钮/en 词表(398键)已就绪✅；剩 97 页硬编码中文扫描→词条库→逐页接入→翻译审校 | 10-15d（持续项目） | 面向国际用户 |
