...
const slides = [
  { id: 'overview', title: '概览', subtitle: '该画家题跋的整体画像',
    ...
    insight: `<p>看一个画家的题跋，首先要看他的<strong>创作周期</strong>。饼图告诉我们每个时期留下了多少作品——作品越多，样本越可靠。如果某个时期只有寥寥几幅，统计结论就不够可信。</p>
<p>右边的柱状图是关键：<strong>情感偏移值</strong>反映画家在不同时期的心境基调。正值偏乐观，负值偏沉重。这个偏移值来自画家规则——是根据历史研究和题跋分析预先设定的。</p>
...
<p>注意看<strong>权重</strong>的变化——晚期作品的权重通常更高，因为画家的技法和思想都更成熟，晚期的题跋往往更能代表其真实的内心世界。</p>`,
  ...
  { id: 'sentiment', title: '情感分析', subtitle: '画作情绪的全景扫描',
    ...
    insight: `<p>左边的饼图展示消极/中性/积极的整体比例。这个比例本身就是画家"情感DNA"的快照——有的画家七成作品是消极的，有的则大部分是积极的。</p>
<p>右边的散点图更有意思——每一幅画按创作年份排列，纵轴是<strong>VADER 综合情感分</strong>（八维度加权，-1到+1）。虚线是趋势线：趋势线向下说明越画越沉重，向上说明晚年更豁达，平稳说明情感基调始终如一。</p>
...
<p>右边的堆叠柱状图展示各时期主题的变化规律。如果"身世自况"在晚期大幅上升，说明画家晚年更倾向于在画中倾诉个人遭遇。如果"时事讽喻"集中在某个时期，那往往对应着当时的社会动荡。</p>
...
<p>右边的面积分布图告诉我们：题跋占画面的比例集中在哪个区间。比例越大，说明画家越重视文字表达，甚至不惜"侵占"画面空间来抒发情感。有些画家晚期的题跋面积比早期大了三倍——那不是画不下，而是有太多话要说。</p>
...
<p>右边列出该画家所有<strong>非中性印章</strong>的得分。印章是画家的"签名"——"苦李"得 -1.0 分（极度消极），因为这是用来自嘲的号；"卖画不为官"得 +1.0（极度积极），表达不向权贵低头的傲骨。</p>`,
  ...
  { id: 'ranking', title: '情感排行', subtitle: '情感最极端的作品——点击查看详情',
    ...
    insight: `<p>左边是这位画家<strong>情感最沉重</strong>的 10 幅作品，右边是<strong>最积极乐观</strong>的 10 幅。这些是八维度综合评分的极端值——不是单一维度的偏高偏低，而是所有维度的综合判断。</p>
...
<p>点击任意一条可以跳转到作品详情页，查看完整的题跋内容、每个维度的评分明细和分析推理过程。</p>`,
  ...
  { id: 'spatial', title: '空间与形式', subtitle: '画幅大小与题跋策略',
    ...
    insight: `<p>左边的散点图探索一个有趣的问题：<strong>大画和小画的题跋策略是否不同？</strong>如果散点呈水平分布，说明无论画幅大小，题跋占比始终如一——这是一种稳定的个人风格。如果大画的散点偏高，说明画家在大画上更敢写。</p>
<p>右边统计题跋的<strong>空间布局形式</strong>。传统文人画最常见的布局是"边角规整式"——题跋规矩地写在画面边角，不打扰主体。而"穿插式"则是大胆地将文字融入画面，让书法成为构图的一部分。</p>
...
<p>题跋面积和布局形式的组合，能看出画家是"保守型"还是"突破型"的创作者。</p>`,
  ...
  { id: 'material', title: '画材与尺寸', subtitle: '画了什么、用的多大的纸',
    ...
    insight: `<p>左边统计这位画家最常画的<strong>题材和元素</strong>。在中国画的传统里，每种题材都有象征意义——竹子象征坚韧不屈，兰花象征高洁典雅，梅花象征傲骨凌霜，菊花象征隐逸淡泊。</p>
<p>题材偏好本身就是一种情感表达。一个画家如果一生都在画竹子，他可能在用竹子表达自己的人生态度。如果晚期突然开始画"枯木""残荷"，这往往是心境变化的信号——从积极向上转为感慨人生。</p>
<p>右边展示尺幅偏好。小幅作品（如册页、扇面）适合随手抒发，是日常情感的自然流露。大幅作品（如中堂、条屏）则需要郑重其事，往往是在重要场合或特殊心境下创作的。</p>
