          ...
          <div class="al-table-body">
            <div v-for="doc in literature" :key="doc.id" class="al-table-row" @click="openReader(doc)">
              <div class="al-tcol al-tcol-title">
                ...
                <div v-if="doc.keywords" class="al-table-keywords">
...
.al-table-row { min-height: 52px; border-bottom: 1px solid #f0ede8; cursor: pointer; transition: background 0.12s; }
...
.al-tcol-title { flex: 1; min-width: 0; padding: 8px; }
.al-table-title { font-weight: 500; overflow: hidden; text-overflow: ellipsis; white-space: nowrap; }
.al-table-keywords { display: flex; flex-wrap: wrap; gap: 4px; margin-top: 4px; }
