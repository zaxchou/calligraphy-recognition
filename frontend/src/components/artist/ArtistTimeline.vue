...
const DYNASTY_ORDER = [
  ...
  { key: '隋唐', label: '隋唐', range: '581-907', norm: /(隋)?唐(代|朝)?/ },
  { key: '五代十国', label: '五代十国', range: '907-960', norm: /五代|南唐|后梁|前蜀|后蜀/ },
  { key: '辽金', label: '辽金', range: '916-1234', norm: /^(辽|金)(代|朝)?|辽金/ },
  { key: '宋', label: '宋', range: '960-1279', norm: /^(北|南)?宋(代|朝)?$/ },
  { key: '元', label: '元', range: '1271-1368', norm: /^元(代|朝)?$/ },
  { key: '明', label: '明', range: '1368-1644', norm: /^明(代|朝)?$/ },
  { key: '清', label: '清', range: '1644-1911', norm: /^清(代|朝|末)?$/ },
