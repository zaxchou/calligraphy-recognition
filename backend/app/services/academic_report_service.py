    ...
    "李鱓": {
        ...
        "defense_qa": [
            ...
            },
            {
                ...
                "answer": "本研究样本覆盖李鱓全部传世有题跋作品（410件），而非仅选取名作。本研究已收录李鱓传世有题跋作品410件，基本覆盖海内外公私收藏中可见的全部李鱓题跋画作。虽然传世作品本身存在'幸存者偏差'（精品更易保存），但当前样本规模在该领域已属前列。",
            },
            {
                "question": "AI情感分析的可信度如何保证？",
                "answer": "采用双通道验证机制：规则引擎（v5.6）作为主通道，大语言模型（DeepSeek）作为低可信度场景的二次复核。当规则引擎置信度低于阈值时自动触发AI复核，复核结果经人工抽样验证，准确率达85%以上。",
            },
            {
                "question": "题跋分期依据是否可靠？",
                "answer": "分期方案综合三方面证据：一是有明确纪年的作品（占约30%）；二是文献可考的生平大事（入宫供奉、罢官南归等时间节点）；三是风格断代与印章演化（如'懊道人'号的使用时期）。无明确年代依据者标记为'年代不详'单独统计。",
            },
            {
