...
from app.modules.pantianshou_composition.storage import build_static_url, to_rel_path
...
def analyze_composition(self, task_id: str) -> None:
    ...
    try:
        ...
        update_job(task_id, report_json_path=to_rel_path(ctx.report_json_path), pdf_path=to_rel_path(ctx.pdf_path), overlay_heatmap_url=ctx.heatmap_url)
